...
const Sidebar = ({ activePage, onNavigate, backendOnline }) => (
  <aside style={{
    ...
    <div style={{ padding: '28px 24px 20px', borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
      ...
      <h1 style={{ fontFamily: 'var(--font-display)', fontSize: 17, fontWeight: 500, color: '#FFF', lineHeight: 1.3 }}>
        GestãoIgreja
      </h1>
      <p style={{ fontSize: 11, color: 'rgba(255,255,255,0.4)', marginTop: 2 }}>Sistema de Gestão</p>
    </div>

    {/* Nav */}
    <nav style={{ flex: 1, padding: '16px 12px' }}>
      <div style={{ fontSize: 10, fontWeight: 500, letterSpacing: '0.08em', color: 'rgba(255,255,255,0.35)', textTransform: 'uppercase', padding: '0 12px', margin: '16px 0 6px' }}>
        Principal
      </div>
      {NAV_ITEMS.map(({ id, label, Icon }) => (
        <button
          ...
          style={{
            ...
            color: activePage === id ? 'var(--brown)' : 'rgba(255,255,255,0.6)',
